...
import { Row, Col, Form, FormItem, Input, Label, Slider, Icon } from 'epm-ui';
...
class AngleSlider extends Component {
  ...
  componentDidMount() {
    this.props.handleGetSliderVal( this.props.popName, this.getValue() );
  }
  ...
  formChange( formData ) {
    this.props.handleGetSliderVal( this.props.popName, formData );
  }
